...
export class AddTBLProducts1702541822043 implements MigrationInterface {
    name = 'AddTBLProducts1702541822043'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_ff56834e735fa78a15d0cf21926" FOREIGN KEY ("categoryId") REFERENCES "cateogries"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
